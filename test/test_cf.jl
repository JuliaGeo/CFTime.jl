...
@testset "Decoding/decoding CF time data" begin
    ...
    t = CFTime.timedecode(1e9, "nanoseconds since 2000-01-01 00:00:00.001", "proleptic_gregorian",prefer_datetime = false);
    @test CFTime.second(t) == 1

    t = CFTime.timedecode(1e9, "nanoseconds since 2000-01-01 00:00:00.001", "proleptic_gregorian")
    @test CFTime.second(t) == 1
end
