...
[![Build Status Windows](https://ci.appveyor.com/api/projects/status/github/JuliaGeo/CFTime.jl?branch=master&svg=true)](https://ci.appveyor.com/project/JuliaGeo/ncdatasets-jl)
